...
RSpec.describe Queries::Sort do
    ...
    context 'when sort_direction is a single column' do
      ...
      context 'when sort_direction is invalid' do
        ...
        it 'raises an error' do
          expect { sort }.to raise_error(ArgumentError, "Invalid sort direction: #{sort_direction}, must be one of #{described_class::SORT_DIRECTIONS}")
        end
      end
